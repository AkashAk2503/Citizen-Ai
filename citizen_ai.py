...
Original file is located at
    https://colab.research.google.com/drive/194RSQKPZzGvrc_QynHahcXTxEqO6tlds
"""
...
def citizen_interaction(query):
    prompt = f"As a government assistant, provide accurate and helpful information about the following citizen query related to public services, government policies, civic issues: \n\nQuery: {query}"
    return generate_response(prompt, max_length=1000)
